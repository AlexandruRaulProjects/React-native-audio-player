...
function SignIn({ navigation }) {
    ...
    if (formIsValid) {
      ...
      try {
        ...
        Alert.alert(
          ...
          "Could not log you in. Check you credentials or come back later!"
        );
      }
  ...
  return (
    <CustomLinearGradient style={styles.gradient}>
      <Text style={styles.title}>Audio[book]</Text>
      ...
      <View style={styles.dontHaveAnAccountContainer}>
        ...
        <View style={styles.thenSignUpContainer}>
          ...
          <Text style={styles.signUpButton} onPress={signUpHandler}>
            Sign up
          </Text>
        </View>
      </View>
